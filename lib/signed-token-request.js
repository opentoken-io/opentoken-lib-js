 ...
 */
module.exports = (bluebird, fs, host, logger, request, requestAsync, requestHandler, signer, StreamPassThrough, tokenDownloader, Uri) => {
    var Bluebird;
    ...
    class SignedTokenRequest {
        ...
        uploadFromFile(stream) {
            ...
            // The former is used to calculate the body hash
            // and the latter is used for the POST request.
