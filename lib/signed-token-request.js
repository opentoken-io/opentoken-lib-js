 ...
 */
module.exports = (fs, logger, signer, requestAsync, requestHandler, Uri) => {
    /**
    ...
    class SignedTokenRequest {
         ...
         *
         * @param {string} host - OpenToken host.
         * @param {string} accountId - Account ID.
         * @param {boolean} isPublic
         * @param {string} code
         * @param {string} secret
         */
        constructor(host, accountId, isPublic, code, secret) {
            this.host = host;
        ...
        create(contents) {
            ...
            requestOptions = requestHandler.buildRequestOptions(url, this.host, "POST");
        ...
        createFromFile(stream) {
            ...
            return stream.pipe(requestAsync(requestOptions).then(requestHandler.checkResponse));
        }
        ...
        downloadToFile(filePath) {
            ...
            requestOptions = requestHandler.buildRequestOptions(url, this.host, "GET");
            signer.sign(this.code, this.secret, requestOptions);
