...
module.exports = (crypto, streamToPromise, StreamConcat, StreamReadable) => {
     ...
     * use this class over a simple concated and hashed string is to
     * allow streaming requests. The stream will be piped so you must
     * push the content to another stream for the request.
     */
    class ContentHasher {
        /**
         * @param {string} secret
