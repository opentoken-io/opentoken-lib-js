...
/**
 * @typedef {Object} AuthorizationBuilder builds components for signing requests
 *                                        for OpenToken.
 ...
 * @param {urijs} Uri
 * @return {opentoken-lib-js~AuthorizationBuilder}
 */
module.exports = (crypto, logger, Uri) => {
    /**
     * Responsible for building the authorization header for an
     * OpenToken request.
     */
