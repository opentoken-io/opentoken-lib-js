...
/**
 * @typedef {Object} requestOptions - The options that are normally provided to the "requests" module.
...
module.exports = function (crypto, logger, URI) {
    /**
    ...
    class AuthorizationBuilder {
        ...
        buildHeaderValue(signature) {
            ...
            value = `OT1-HMAC-SHA256-HEX; access-code=${this.accountDetails.code}; signed-headers=${signedHeaders}; signature=${signature}`;
        ...
        createHeader() {
            ...
            hmac = crypto.createHmac("sha256", this.accountDetails.secret);
